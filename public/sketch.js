...
const socket = io.connect('http://localhost:3000');
  // const socket = io.connect('https://coboard.herokuapp.com/');
 
// console.log("DEVELOPED BY LAKSHY GUPTA -> github.com/lakshygupta");
...
const name = prompt("Enter your Name to join CoBoard ");
console.log(name);
...
socket.on('recieve', data => {
  ...
  // const dis = screen.width - 40;
  storeItem('Counter', data);
    //     fill(0,0,51);
    //     rect(dis, 0, 50, 50);
    // Counterr = createInput(data);
    // Counterr.position(dis, 0);
    // Counterr.style('width', '95px'); 
    // Counterr.style('font-size', '15px'); 
    // Counterr.style('margin-left', '0px');
    // Counterr.style('background-color', 'transparent'); 
    // Counterr.style('border-color', 'transparent');
    // Counterr.style('color', 'white');
    // if (mouseIsPressed) {
        
    //     // print(Counterr.value());
    //     console.log("inside mousePressed")
    //     // print(getItem('Counter'));
    //   }
    //   if(getItem('Counter') > data || getItem('Counter') < data){
    //     fill(255, 0, 199);
    //     rect(100, 0, 50, 50);
    //     Counterr.clear();
    ...
    //   }
      ...
      // console.log(document.getElementsByClassName('footerr'));
      // document.getElementsByClassName("footerr")[0].outerText = data;
})
    ...
    if (mouseIsPressed) {
        if (mouseX <= 50) {
          if (mouseY <= 50) {
            ...
            createA("https://www.geeksforgeeks.org/", 
                       "Go to GeeksforGeeks", "_self"); 
          }
        }
...
//   rect(0, 350, 50, 50);
  ...
  image(imgT, 0, 410, imgT.width /10, imgT.height / 11);
}
